...
const { createPlan, getAllPlans, getPlanById, updatePlanById, deletePlan } = require('../controllers/planController');
...
router.delete('/:id', verifyToken, authorize("SUPER_ADMIN"), deletePlan);
