...
const { createSchool, getAllSchools, getSchoolById, updateSchoolById, deleteSchoolById, getSchoolStatsOverview } = require("../controllers/schoolsController");
...
router.get("/stats/overview", verifyToken, authorize(["SCHOOL_ADMIN", "ASSISTANT", "ACCOUNTANT", "SUPER_ADMIN"]), getSchoolStatsOverview);
